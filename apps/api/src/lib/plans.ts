...
export const PLAN_CATALOG: Record<PlanKey, PlanDefinition> = {
  ...
  STARTER: {
    name: '個人版', tagline: '個人與自由工作者的日常整合', monthlyPriceTwd: 990, annualPriceTwd: 9_900,
  ...
  PROFESSIONAL: {
    name: '專業版', tagline: '小型團隊的自動化與重複工作', monthlyPriceTwd: 2_990, annualPriceTwd: 29_900,
  ...
  BUSINESS: {
    name: '商務版', tagline: '部門級權限、稽核與多資料來源', monthlyPriceTwd: 7_990, annualPriceTwd: 79_900,
  ...
  ENTERPRISE: {
    name: '企業授權', tagline: '大型內部部署與客製治理', monthlyPriceTwd: 19_900, annualPriceTwd: 199_000,
