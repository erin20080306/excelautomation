...
export const PLAN_CATALOG: Record<PlanKey, {
  ...
  STARTER: { name: '個人版', priceTwd: 12_800, fileQuota: 10, totalMbQuota: 4, outputMbQuota: 4.2, downloadQuota: 2, seats: 1, devices: 1, supportMonths: 12, features: ['Windows 與 macOS 安裝包', '限 1 台裝置', '本機批次處理', '一年更新'] },
