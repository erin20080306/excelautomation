...
export function QueuePage() {
  ...
  return <><PageHeader title="處理紀錄" description="Vercel 試用版採請求內即時處理；下載包保留 PostgreSQL Queue、重試與大量背景批次。" action={<button className="btn-secondary" onClick={() => jobs.refetch()}><RefreshCw size={16} />立即更新</button>} />
