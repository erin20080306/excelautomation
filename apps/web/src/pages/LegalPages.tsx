...
export function PrivacyPage() {
  return <LegalLayout title="隱私權政策" subtitle="說明 ExcelMaster 在帳號、試用、訂閱、檔案處理、安裝包下載與裝置授權流程中如何處理資料。">
    ...
    <h2>四、保存與刪除</h2><p>保存期間依服務提供、訂閱、稽核、備份及法定義務所需決定。試用或訂閱終止後，應提供合理期間讓使用者匯出資料，再依正式資料保留表刪除或去識別化。付款、稅務與安全稽核可能依法保存較久。</p>
    <h2>五、委外服務與跨境</h2><p>目前可能使用 Vercel、Neon、Resend、Cloudflare Turnstile，以及日後啟用的 ECPay 或 Stripe。這些供應商只在提供代管、資料庫、Email、人機驗證及金流所需範圍處理資料，資料可能依其基礎設施跨境傳輸。</p>
    <h2>六、使用者權利</h2><p>使用者可要求查詢、更正、取得副本、停止處理或刪除個人資料；若因契約、資安或法定保存義務無法立即刪除，平台應說明原因。請透過帳號所屬平台管理者提出申請。</p>
    <h2>七、檔案中的第三人資料</h2><p>上傳包含員工、客戶或供應商資料前，使用者應確認具有合法依據並只上傳必要欄位。涉及身分證號、醫療、金融或其他敏感資料時，應先去識別化並評估是否適合使用本服務。</p>
    <h2>八、政策更新</h2><p>重大變更會在服務內公告並更新版本日期；若變更影響既有資料使用目的，將依法取得同意或提供選擇。</p>
  </LegalLayout>;
}
...
export function SecurityPolicyPage() {
  return <LegalLayout title="安全政策" subtitle="ExcelMaster 採取的帳號、資料、下載、授權與事件處理控制，以及使用者應共同遵守的安全責任。">
    ...
    <h2>二、資料與傳輸</h2><p>正式服務使用 HTTPS。密鑰只應存放於受控環境變數；檔案、資料庫與備份應限制存取並設定保存期限。安裝包以 SHA-256 驗證，下載網址短效且只能使用一次。</p>
